  ...
  return (
    <div className="container">
      <div className="left-side">
        <div className="linkup-title">
          <h1>LinkUp</h1>
        </div>
        <div className="slogan">
          <p>Bringing Conversations Together, Anytime, Anywhere.</p>
        </div>
      </div>
            ...
            {isLogin ? (
              <>
                ...
                <form  onSubmit={handleLogin}>
                  ...
                  <Typography className="or-divider">OR</Typography>
                  <Button
                    variant="text"
                    onClick={toggleLogin}
                    fullWidth
              ...
              <>
                ...
                >
                  <Stack position="relative">
                    <Avatar src={avatar.preview} className="avatar" />
